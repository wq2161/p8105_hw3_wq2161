...
```
    ...
    ## # A tibble: 50,400 × 6
    ##     week day_id day    day_end activity_min data_value
...
are week, day\_id, day, day\_end, activity\_min, data\_value, and 50400
observations. Specifically, the activity\_min is the activity counts for
